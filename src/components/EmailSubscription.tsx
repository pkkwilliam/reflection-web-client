...
const EmailSubscription = () => {
  ...
  const onClickSubscribe = async () => {
    console.log('onClickSubscribe', email);
    try {
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <p className="mt-4 text-lg text-gray-300">
              Be the first to know when NoFlee is ready to launch! Sign up with
              your email, and we’ll keep you updated on our progress, exciting
              features, and when the app is available for download. Together,
